                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                                    ...
                                    <tr>
                                        <td align="left" bgcolor="#cfe2f3"
                                            style="padding:0;Margin:0;padding-top:20px;padding-left:20px;padding-right:20px;background-color:#cfe2f3">
                                            <table width="100%" cellspacing="0" cellpadding="0"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr>
                                                            ...
                                                            <tr>
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <p
                                                                        ...
                                                                        Kérjük a lenti gomb segítségével
                                                                        Módosítsa jelszavát!&nbsp;<br>Jó vásárlást
                                                                        kívánunk!</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        További szép napot!<br>Az italdiszkont
                                                                        csapata.<br></p>
                                                                </td>
                                                            </tr>
                                                        </table>
