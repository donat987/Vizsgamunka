...
<head>
    ...
    <title>Copy of New message</title>
    <!--[if (mso 16)]>
<style type="text/css">
                                                                    ...
                                                                    <table class="es-menu" width="100%"
                                                                        ...
                                                                        <tr class="links">
                                                                            ...
                                                                            <td style="Margin:0;padding-left:5px;padding-right:5px;padding-top:9px;padding-bottom:10px;border:0"
                                                                                ...
                                                                                bgcolor="transparent" align="center"><a
                                                                                    target="_blank"
                                                                                    href="https://dalosdonat.hu/termekek"
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    ...
                                                                    <h1
                                                                        ...
                                                                        <strong>Státusz válzozás történt!</strong>
                                                                    </h1>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <tr>
                                                    <td align="left" style="padding:0;Margin:0;width:270px">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;padding-right:10px;font-size:0px">
                                                                    <table border="0" width="100%"
                                                                        height="100%" cellpadding="0"
                                                                        cellspacing="0" role="presentation"
                                                                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                            ...
                                                            <tr>
                                                                <td align="right" class="es-m-txt-c"
                                                                    ...
                                                                    <table
                                                                        ...
                                                                        <tr>
                                                                            <td
                                                                                style="padding:0;Margin:0;text-align:right;line-height:21px;font-size:14px">
                                                                        ...
                                                                        <tr>
                                                                            <td
                                                                                style="padding:0;Margin:0;text-align:right;font-size:14px;line-height:21px">
                                                                                <font style="vertical-align:inherit">
                                                                                    <font
                                                                                        style="vertical-align:inherit">
                                                                                        <font
                                    ...
                                    <tr>
                                        <td align="left"
                                            style="padding:0;Margin:0;padding-bottom:20px;padding-left:20px;padding-right:20px;background-position:center top">
                                            <table cellpadding="0" cellspacing="0" width="100%"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr>
                                                    <td align="center" valign="top"
