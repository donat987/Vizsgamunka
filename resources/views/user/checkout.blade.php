                    ...
                    <div class="col-md-6 mb-5 mb-md-0">
                        ...
                        <div class="p-3 px-5 border mb-3">
                            <div class="form-check d-flex align-items-center">
                                <input class="form-check-input me-3" type="checkbox" value="{{$sor->id}}" id="defaultCheck1">
                                <label class="form-check-label" for="defaultCheck1">
                                    <div class="col-sm-12">
                                        <p class="mb-0">Teljes név: {{$sor->name}}</p>
                                        <p class="mb-0">Cím: {{$sor->zipcode}} {{$sor->city}} {{$sor->street}} {{$sor->house_number}}</p>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6" >
                                    <label for="város" class="text-black">Város <span
                                        class="text-danger">*</span></label>
                                    <input type="text" class="form-control" required="" id="város" name="város[city]"
                                        placeholder="Város">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="utca" class="text-black">Utca <span
                                        class="text-danger">*</span></label>
                                    <input type="text" class="form-control" required="" id="utca" name="utca[street]"
                                        placeholder="Utca">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="házszám" class="text-black">Házszám, emelet, ajtó </label>
                                <input type="text" class="form-control" required="" id="házszám" name="házszám[number]"
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="email" class="text-black">Email <span
                                            class="text-danger">*</span></label>
                                    <input type="text" required="" class="form-control" id="email" name="email[email]">
                                </div>
                            </div>
